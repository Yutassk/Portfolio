    ...
    <main className="pt-24 lg:w-1/2 lg:py-24">
      ...
      <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
        ...
        <div>
          ...
          <p>
            個人的な趣味としてバイナリをいじってみたり、スクレイピングアプリを作成したり、ひたすらタイピングしたりなどしています。タイピング速度は
            <span className="text-slate-200">寿司打が16,000円（高級コース）、e-typingが373pt（腕試し）</span>ほどです。HHKB愛好者です。
          </p>
        </div>
      </section>
              ...
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:col-span-6">
                  ...
                  <p className="mt-2 text-sm leading-normal">
                    ...
                    三項演算子やifなど動的なスタイリングについてはもう少し慣れが必要。
                  </p>
                </div>
              </div>
            </li>
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  <h3>
                    <a
                      ...
                      href="https://portfolio-eight-mu-52.vercel.app/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <span>
                  ...
                  <p className="mt-2 text-sm leading-normal">
                    Vanilla
                    JSで作成したカレンダーです。シフト提出アプリを作成するにあたって当日より前の日付は入力できないように制限をかけました。また、クリックされた日付はグレーアウトされ、同じ日付を重複入力することができないようにしています。
                  </p>
