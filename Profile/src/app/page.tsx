            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                  The kit comes with three pre-built pages to help you get started faster. You can change the text and images and you're good to go. Just make sure you enable them first via
                  JavaScript.
                </p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <Image alt="..." src={"/team-1-800x800.jpg"} className="shadow-lg rounded-full max-w-full mx-auto" style={{ maxWidth: "120px" }} width={100} height={100} />
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <Image alt="..." src={"/team-2-800x800.jpg"} className="shadow-lg rounded-full max-w-full mx-auto" style={{ maxWidth: "120px" }} width={100} height={100} />
                  <div className="pt-6 text-center">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <Image alt="..." src={"/team-3-800x800.jpg"} className="shadow-lg rounded-full max-w-full mx-auto" style={{ maxWidth: "120px" }} width={100} height={100} />
                  <div className="pt-6 text-center">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <Image alt="..." src={"/team-4-470x470.png"} className="shadow-lg rounded-full max-w-full mx-auto" style={{ maxWidth: "120px" }} width={100} height={100} />
                  <div className="pt-6 text-center">
