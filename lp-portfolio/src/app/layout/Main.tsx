        ...
        <main>
          ...
          <section className="">
            <div className="px-5 m-auto">
              <div></div>
              <h2 className="text-center text-3xl py-2">Profile</h2>
            ...
            <div>
              ...
              <ul>
                <li className="card">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus qui inventore optio molestias ex tempora amet minus blanditiis quis perferendis? Eos facere neque temporibus
                    vel modi fugit mollitia, eaque dolores?
                  </p>
                </li>
                <li className="card">
                  <div className="card_header">
